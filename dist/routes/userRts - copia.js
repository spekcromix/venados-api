...
class UserRoutes {
    ...
    config() {
        ...
        this.router.get('/', [authentication_1.AUTH.verifyToken, authentication_1.AUTH.verifyAdmin], userCtrl_1.default.read);
        this.router.get('/:id', userCtrl_1.default.readOne);
